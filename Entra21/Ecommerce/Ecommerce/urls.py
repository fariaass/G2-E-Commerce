...
urlpatterns = [
    ...
    path('produtos/maisVisitados/', retorna_produtos_mais_visualizados, name='maisVisitados'),
    path('produtos/maisVendidos/', retorna_produtos_mais_vendidos, name='maisVendidos'),
    path('produtos/', retorna_produtos, name='retorna_produtos'),
    path('produtos/<int:pk>/', detalhes_produto, name='detalhes_produto'),
